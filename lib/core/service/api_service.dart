...
abstract class AppApiService extends ChopperService
{
  ...
  Future<Response> signIn({ // Consider using Response<YourResponseType> if you have one
    @Field('email') required String email,
    @Field('password') required String password,
    @Field('full_name') required String fullName, // Assuming API needs this too based on repo
  });
}